...
<body>
    ...
    <div class="container">
        ...
        <div class="content-wrapper">
            ...
            <!-- 탭 메뉴 시작 -->
            <div class="tabs">
                <button class="tab-button active" onclick="location.href='../member/member-search-id'">아이디찾기</button>
                <button class="tab-button" onclick="location.href='../member/member-search-pw'">비밀번호 찾기</button>
            </div>
            <!-- 탭 메뉴 끝 -->
            ...
            <div class="form-container">
                <form>
                    ...
                    <button type="check" class="btn btn-secondary" onclick="location.href='../member/member-search-pw'">비밀번호 찾기</button>
                    <!-- 확인 버튼 끝 -->
