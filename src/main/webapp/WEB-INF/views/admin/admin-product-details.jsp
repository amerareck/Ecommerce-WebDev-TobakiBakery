        ...
        <div class="main-content">
            ...
            <aside class="sidebar">
                ...
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item"><a class="nav-link" href="../admin/admin-main.html">관리자메인</a></li>
                </ul>
                <hr class="hr"/>
                <h3>상품관리</h3>
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item"><a class="nav-link active" href="../admin/admin-product-details.html">상품등록</a></li>
                    <li class="nav-item"><a class="nav-link" href="../admin/admin-main.html#orderList">주문조회</a></li>                   
                </ul>
                <hr class="hr"/>
                <h3>고객센터</h3>
                <ul class="nav nav-pills flex-column">
