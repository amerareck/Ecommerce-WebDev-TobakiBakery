...
public class CategoryTypeHandler extends BaseTypeHandler<Category> {
    ...
    public Category getNullableResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return Category.fromValue(value); // 데이터베이스의 값을 Enum으로 변환
    }
    ...
    @Override
    public Category getNullableResult(java.sql.CallableStatement cs, int columnIndex) throws SQLException {
